...
TEAM_327THMEDICPVT = DarkRP.createJob("327th-Medic PVT", {
    ...
    weapons = {"med_kit", "zbl_gun", "weapon_fists", "sw_datapad", "rw_sw_dc15s", "rw_sw_dc15a_o", "tfa_defi_swrp", "jet_exec", "rw_sw_nade_bacta", "weapon_bactainjector", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "keys", "bkeycard", "re_hands", "rw_sw_stun_dc15s"},
    command = "327medicpvt",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_327THMEDICCPT = DarkRP.createJob("327th-Medic CPT", {
    ...
    weapons = {"rw_sw_dual_dc17ext", "med_kit", "zbl_gun", "weapon_fists", "sw_datapad", "rw_sw_dc15s", "rw_sw_dc15a_o", "tfa_defi_swrp", "jet_exec", "rw_sw_nade_bacta", "weapon_bactainjector", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "keys", "bkeycard", "re_hands", "rw_sw_stun_dc15s"},
    command = "327mediccpt",
    max = 1,
    salary = 100,
    admin = 0,
