TEAM_JESSE = DarkRP.createJob("ARC 2ndLT Jesse", {
    ...
    model = {"models/fisher/rogue/501st/jesse.mdl"},
...
TEAM_FIVES = DarkRP.createJob("ARC 2ndLT Fives", {
    color = Color(0, 0, 255, 255),
    model = {"models/fisher/rogue/501st/fives.mdl"},
...
TEAM_ECHO = DarkRP.createJob("ARC 2ndLT Echo", {
    color = Color(0, 0, 255, 255),
    model = {"models/fisher/rogue/501st/echo.mdl"},
...
TEAM_HARDCASE = DarkRP.createJob("TC CPL Hardcase", {
    ...
    model = {"models/player/svenman/bf2_reg/501st_hardcase/501st_hardcase.mdl"},
...
TEAM_KIX = DarkRP.createJob("TC MED SGT Kix", {
    color = Color(255, 255, 255, 255),
    model = {"models/player/svenman/bf2_reg/501st_kix/501st_kix.mdl"},
...
TEAM_DOGMA = DarkRP.createJob("TC CPL Dogma", {
    color = Color(255, 255, 255, 255),
    model = {"models/player/svenman/bf2_reg/501st_dogma/501st_dogma.mdl"},
...
TEAM_APPO = DarkRP.createJob("TC SGT Appo", {
    color = Color(255, 255, 255, 255),
    model = {"models/player/svenman/bf2_reg/501st_appo/501st_appo.mdl"},
