...
TEAM_MARIENSCPL = DarkRP.createJob("Mariens CPL", {
    ...
    weapons = {"rw_sw_dc15s", "rw_sw_dc15le", "rw_sw_dc17ext", "rw_sw_nade_flash", "rw_sw_nade_thermal", "realistic_hook", "weapon_breachingcharge", "rw_sw_z6", "salute_swep", "cross_arms_infront_swep", "cross_arms_swep"},
    command = "MARIENSCPL",
    max = 8,
    salary = 100,
    admin = 0,
...
TEAM_MARIENS2NDLT = DarkRP.createJob("Mariens 2ndLT", {
    ...
    weapons = {"rw_sw_dc15s", "rw_sw_dc15le", "rw_sw_dual_dc17ext", "rw_sw_nade_flash", "rw_sw_nade_thermal", "realistic_hook", "weapon_breachingcharge", "rw_sw_z6", "salute_swep", "cross_arms_infront_swep", "cross_arms_swep"},
