...
TEAM_CHIMEARA = DarkRP.createJob("MCMD 2121 Chimeara", {
    ...
    weapons = {"rw_sw_dc15le_o", "rw_sw_dc15s", "rw_sw_dual_dc17ext", "rw_sw_valken38x", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_bactainjector", "weapon_armorkit", "jet_exec", "seal6-c4", "rw_sw_nade_thermal"},
    command = "chimeara",
    max = 1,
    salary = 250,
    admin = 0,
