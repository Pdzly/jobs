TEAM_442thTechniker = DarkRP.createJob("442th Techniker", {
    ...
    weapons = {"rw_sw_dc15a_o", "rw_sw_dc15s", "rw_sw_dc17ext", "alydus_fortificationbuildertablet", "cross_arms_swep", "cross_arms_infront_swep", "salute_swep", "weapon_fists", "re_hands", "rw_sw_dp23", "alydus_fusioncutter", "sw_datapad", "weapon_armorkit", "rw_sw_nade_thermal", "weapon_extinguisher_infinite", "weapon_breachingcharge"},
...
TEAM_442thTechnikerOffizer = DarkRP.createJob("442th Techniker Offizier", {
    ...
    weapons = {"rw_sw_dc15a_o", "rw_sw_dc15s", "alydus_fortificationbuildertablet", "cross_arms_swep", "cross_arms_infront_swep", "salute_swep", "weapon_fists", "re_hands", "rw_sw_dp23", "alydus_fusioncutter", "sw_datapad", "weapon_armorkit", "rw_sw_dual_dc17ext", "weapon_cuff_elastic", "rw_sw_nade_thermal", "weapon_extinguisher_infinite", "weapon_breachingcharge"},
