TEAM_442THPILOT = DarkRP.createJob("442th Pilot", {
    ...
    weapons = {"rw_sw_dc17ext", "alydus_fortificationbuildertablet", "cross_arms_swep", "cross_arms_infront_swep", "salute_swep", "weapon_fists", "re_hands", "rw_sw_dc15s", "rw_sw_dc15a_o", "rw_sw_nade_thermal"},
    command = "442thpilot",
    salary = 250,
    admin = 0,
    max=0,
...
TEAM_442THPILOTOffizier = DarkRP.createJob("442th Pilot Offizier", {
    ...
    weapons = {"alydus_fortificationbuildertablet", "cross_arms_swep", "cross_arms_infront_swep", "salute_swep", "weapon_fists", "re_hands", "rw_sw_dc15s", "rw_sw_dc15a_o", "rw_sw_dual_dc17ext","weapon_cuff_elastic", "rw_sw_nade_thermal"},
