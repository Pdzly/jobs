...
TEAM_DOPFC = DarkRP.createJob("Doom PFC", {
    ...
    weapons = {"re_hands", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_z6", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep"},
    command = "doompfc",
    max = 10,
    salary = 100,
    admin = 0,
...
TEAM_DOLCL = DarkRP.createJob("Doom LCL", {
    ...
    weapons = {"re_hands", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_z6", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal"},
    command = "doomlcl",
    max = 8,
    salary = 100,
    admin = 0,
...
TEAM_DO2NDLT = DarkRP.createJob("Doom 2ndLT", {
    ...
    weapons = {"re_hands", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_z6", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "doom2ndlt",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_DOOM = DarkRP.createJob("Commander Doom", {
    ...
    weapons = {"re_hands", "at_sw_dc15s_all", "rw_sw_z6", "weapon_fists", "rw_sw_dual_dc17", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "cmddoom",
    max = 1,
    salary = 100,
    admin = 0,
