...
TEAM_RMCAUS = DarkRP.createJob("RMC Ausbilder", {
    ...
    weapons = {"re_hands", "weapon_fists", "at_sw_dc15a_all", "at_sw_dc15s_all", "med_kit", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "tfa_defi_swrp", "weapon_cuff_elastic"},
...
TEAM_RMCPVT = DarkRP.createJob("RMC PVT", {
    ...
    description = [[RMC PVT]],
    weapons = {"zbl_spray", "zbl_gun", "weapon_bactainjector", "sw_datapad", "rw_sw_nade_bacta", "keys", "weapon_fists", "at_sw_dc15a_all", "at_sw_dc15s_all", "med_kit", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "tfa_defi_swrp", "weapon_bactainjector"},
    command = "rmcpvt",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_RMCCMD = DarkRP.createJob("RMC Commander", {
    ...
    weapons = {"zbl_spray", "zbl_gun", "weapon_bactainjector", "sw_datapad", "rw_sw_nade_bacta", "stunstick", "keys", "weapon_fists", "at_sw_dc15a_all", "at_sw_dc15s_all", "med_kit", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "tfa_defi_swrp", "weapon_cuff_elastic", "weapon_doomshield", "rw_sw_dual_dc17ext", "jet_mk6", "weapon_bactainjector"},
    command = "rmccmd",
    max = 0,
    salary = 100,
    admin = 0,
