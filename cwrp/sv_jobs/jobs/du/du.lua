...
TEAM_DOMJR = DarkRP.createJob("Doom MJR", {
    ...
    weapons = {"re_hands", "rw_sw_dc15s", "rw_sw_dc15a_o", "weapon_fists", "rw_sw_z6", "rw_sw_shield_rep", "weapon_doomshield", "rw_sw_dual_dc17ext", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "doommjr",
    max = 1,
    salary = 100,
    admin = 0,
