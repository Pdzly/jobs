...
TEAM_DOOMRMC = DarkRP.createJob("DOOMRMC", {
    ...
    description = [[DOOMRMC]],
    weapons = {"re_hands", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists", "weapon_cuff_elastic", "arrest_stick", "unarrest_stick", "tfa_defi_swrp", "rw_sw_dc17","rw_sw_nade_bacta", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep"},
    command = "doomrmc",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_ARCCPTEVO = DarkRP.createJob("ARC COL 1288 Evo", {
    ...
    model = {
        "models/player/suno/arc/arc_4.mdl"
    },
...
TEAM_DOLCL = DarkRP.createJob("Doom LCL", {
    ...
    model = {"models/player/community/einfachgaming/starwars/du_officer_2.mdl"},
    description = [[Doom LCL]],
    weapons = {"re_hands", "rw_sw_dc15s", "rw_sw_dc15a_o", "weapon_fists", "rw_sw_shield_rep", "weapon_doomshield", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal"},
    command = "doomlcl",
    max = 8,
    salary = 100,
    admin = 0,
...
TEAM_DO2NDLT = DarkRP.createJob("Doom 2ndLT", {
    ...
    model = {"models/player/community/einfachgaming/starwars/du_officer_2.mdl"},
    description = [[Doom 2ndLT]],
    weapons = {"re_hands", "rw_sw_dc15s", "rw_sw_dc15a_o", "weapon_fists", "rw_sw_shield_rep", "weapon_doomshield", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "doom2ndlt",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_DOMJR = DarkRP.createJob("Doom MJR", {
    ...
    model = {"models/player/community/einfachgaming/starwars/du_officer.mdl"},
    description = [[Doom MJR]],
    weapons = {"re_hands", "rw_sw_dc15s", "rw_sw_dc15a_o", "weapon_fists", "rw_sw_shield_rep", "weapon_doomshield", "rw_sw_dual_dc17ext", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "doommjr",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_DOOM = DarkRP.createJob("Commander Doom", {
    ...
    model = {"models/player/shader/einfachgaming/starwars/12_du_doom.mdl"},
    description = [[Commander Doom]],
    weapons = {"re_hands", "rw_sw_dc15s","rw_sw_dual_dc17ext","weapon_fists", "rw_sw_dc15a_o", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "cmddoom",
    max = 1,
    salary = 100,
    admin = 0,
