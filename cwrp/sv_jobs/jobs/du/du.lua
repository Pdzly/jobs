...
TEAM_DOLCL = DarkRP.createJob("Doom LCL", {
    ...
    weapons = {"re_hands", "rw_sw_dc15s", "rw_sw_dc15a_o", "weapon_fists", "rw_sw_z6", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal"},
    command = "doomlcl",
    max = 8,
    salary = 100,
    admin = 0,
...
TEAM_DO2NDLT = DarkRP.createJob("Doom 2ndLT", {
    ...
    weapons = {"re_hands", "rw_sw_dc15s", "rw_sw_dc15a_o", "weapon_fists", "rw_sw_z6", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "doom2ndlt",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_DOOM = DarkRP.createJob("Commander Doom", {
    ...
    weapons = {"re_hands", "rw_sw_dc15s", "rw_sw_z6", "weapon_fists", "rw_sw_dual_dc17", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "cmddoom",
    max = 1,
    salary = 100,
    admin = 0,
