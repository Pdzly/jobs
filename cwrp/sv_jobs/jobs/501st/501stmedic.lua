...
TEAM_501stRMC2ndLT = DarkRP.createJob("501st RMC 2ndLT", {
    ...
    weapons = {"weapon_fists", "re_hands", "zbl_spray", "zbl_gun", "weapon_cuff_elastic", "weapon_bactainjector", "sw_datapad", "rw_sw_nade_bacta", "keys", "weapon_fists", "at_sw_dc15a_all",  "med_kit", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "tfa_defi_swrp", "weapon_bactainjector"},
