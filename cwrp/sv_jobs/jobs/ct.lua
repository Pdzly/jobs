...
TEAM_CTCPT = DarkRP.createJob("CT CPT", {
    ...
    model = {"models/player/strasser/bf2/p2_ct/p2_ct_trooper.mdl", "models/defcon/banks/coldwweather/cold_ct/cold_ct.mdl"},
    description = [[]],
    weapons = {"re_hands", "salute_swep", "cross_arms_infront_swep", "rw_sw_dual_dc17ext", "weapon_cuff_elastic", "cross_arms_swep", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists"},
    command = "ctcpt",
    max = 0,
    salary = 20,
    admin = 0,
...
TEAM_CTMJR = DarkRP.createJob("CT MJR", {
    ...
    model = {"models/player/strasser/bf2/p2_ct/p2_ct_trooper.mdl", "models/defcon/banks/coldwweather/cold_ct/cold_ct.mdl"},
    description = [[]],
    weapons = {"re_hands", "salute_swep", "cross_arms_infront_swep", "rw_sw_dual_dc17ext", "cross_arms_swep", "weapon_cuff_elastic", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists"},
    command = "ctmjr",
    max = 0,
    salary = 20,
    admin = 0,
