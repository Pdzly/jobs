...
TEAM_FEVER = DarkRP.createJob("Alpha ARC CPT 69 Fever", {
    ...
    weapons = {"rw_sw_westarm5", "rw_sw_dual_dc17s", "rw_sw_dc15x", "rw_sw_nade_dioxis", "rw_sw_rps6", "tfa_defi_swrp", "seal6-c4", "jet_mk1", "weapon_bactainjector", "salute_swep", "cross_arms_swep", "cross_arms_infront_swep",  "rw_sw_nade_thermal", "weapon_armorkit", "weapon_cuff_elastic"},
    command = "fever",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_ARCMJRCOLT = DarkRP.createJob("ARC MJR Hammer", {
    ...
    weapons = {"at_sw_dc15s_all", "rw_sw_dual_dc17ext", "rw_sw_z6", "rw_sw_rps6", "cross_arms_swep", "cross_arms_infront_swep", "salute_swep", "seal6-c4", "jet_mk1", "weapon_grapplehook", "weapon_bactainjector", "weapon_armorkit", "rw_sw_nade_thermal", "weapon_extinguisher_infinite", "weapon_cuff_elastic", "re_hands", "tfa_defi_swrp"},
    command = "hammer",
    max = 1,
    salary = 100,
    admin = 0,
