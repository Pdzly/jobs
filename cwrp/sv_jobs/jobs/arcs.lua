...
TEAM_MJRARCNICO = DarkRP.createJob("ARC MJR 1299 Nico", {
    ...
    weapons = {"dk_flare_gun", "stunstick", "cross_arms_swep", "cross_arms_infront_swep", "salute_swep", "weapon_cuff_elastic", "weapon_fists", "re_hands", "weapon_bactainjector", "hacktool", "weapon_thehiddenblade", "weapon_extinguisher_infinite", "weapon_breachingcharge", "jet_mk1", "tfa_defi_swrp", "rw_sw_nade_thermal", "rw_sw_bino_dark", "rw_sw_dc17ext", "rw_sw_dual_dc17ext", "rw_sw_westarm5", "rw_sw_shield_rep", "seal6-c4", "rw_sw_nade_smoke", "rw_sw_iqa11c"},
    command = "arcmjrnico",
    max = 1,
    salary = 1000,
    admin = 0,
...
TEAM_ARCDRAKE = DarkRP.createJob("ARC CPT Drake", {
    ...
    weapons = {"dk_flare_gun", "rw_sw_westarm5", "re_hands", "at_sw_dc15a_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_nade_thermal", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_bino_white", "rw_sw_dc17ext", "weapon_cuff_elastic", "rw_sw_dual_dc17ext", "rw_sw_valken38x", "realistic_hook", "rw_sw_dc15x", "weapon_breachingcharge", "tfa_defi_swrp", "t3m4_empgrenade", "zeus_flashbang", "seal6-c4", "rw_sw_rps6", "med_kit"},
    command = "arccptdrake",
    max = 1,
    salary = 500,
    admin = 0,
