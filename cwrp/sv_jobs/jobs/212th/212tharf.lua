--212th ARF--
TEAM_212ARFPVT = DarkRP.createJob("212th ARF PVT", {
    color = Color(255, 255, 255, 255),
    model = {
		"models/fisher/212th/arf/arf_trooper.mdl",
		"models/defcon/banks/coldwweather/212th_cold/212th_trooper/212th_trooper.mdl"
	},
    description = [[212th ARF PVT]],
    weapons = {"dk_flare_gun", "weapon_fists", "re_hands", "at_sw_dc15a_all", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_grapplehook", "at_sw_dc15s_all", "rw_sw_dc15le", "rw_sw_dc17ext"},
    command = "212ARFPVT",
    max = 0,
    salary = 20,
    admin = 0,
...
TEAM_212ARFCPT = DarkRP.createJob("212th ARF CPT", {
    ...
    weapons = {"dk_flare_gun", "weapon_fists", "re_hands", "at_sw_dc15a_all", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_grapplehook", "at_sw_dc15s_all", "rw_sw_dc15le", "rw_sw_dc17ext", "rw_sw_dual_dc17ext"},
    command = "212ARFCPT",
    max = 0,
    salary = 20,
    admin = 0,
