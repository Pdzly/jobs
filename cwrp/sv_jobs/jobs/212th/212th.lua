...
TEAM_212PVT = DarkRP.createJob("212th PVT WIXER", {
    ...
    weapons = {"re_hands", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists", "realistic_hook", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep"},
    command = "212pvt",
    max = 0,
...
TEAM_212LCL = DarkRP.createJob("212th LCL", {
    ...
    weapons = {"re_hands", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_rps6", "realistic_hook", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal"},
    command = "212lcl",
    max = 8,
    salary = 100,
    admin = 0,
...
TEAM_2122ndlt = DarkRP.createJob("212th 2ndLT", {
    ...
    weapons = {"re_hands", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_rps6", "realistic_hook", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "2122ndlt",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_212CPT = DarkRP.createJob("212th CPT", {
    ...
    weapons = {"re_hands", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_rps6", "realistic_hook", "rw_sw_dual_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "212cpt",
    max = 2,
    salary = 100,
    admin = 0,
...
TEAM_Cody = DarkRP.createJob("Commander Cody", {
    ...
    weapons = {"re_hands", "at_sw_dc15s_all", "at_sw_dc15a_all", "weapon_fists", "jet_exec", "rw_sw_rps6", "realistic_hook", "rw_sw_dual_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_nade_thermal", "weapon_cuff_elastic"},
    command = "212cmdcody",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_212THWAXER = DarkRP.createJob("212th 2ndLT Waxer", {
    ...
    weapons = {"weapon_fists", "re_hands", "at_sw_dc15a_all", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_grapplehook", "at_sw_dc15s_all", "rw_sw_dc15x", "at_sw_dc15a_all", "rw_sw_nade_thermal"},
    command = "212thwaxer",
    max = 1,
    salary = 100,
    admin = 0,
