...
TEAM_Mandalorianer = DarkRP.createJob("Jax Kier'ha", {
    ...
    weapons = {"weapon_fists", "re_hands", "rw_sw_nt242c", "rw_sw_scattershotgun", "rw_sw_k16", "rw_sw_wristblaster_light_purple", "rw_sw_wristflame", "rw_sw_wristrocket", "jet_mk1", "seal6-c4", "tfa_defi_swrp", "weapon_extinguisher_infinite", "weapon_bactainjector", "weapon_armorkit", "weapon_cuff_elastic", "extinguisher_infinite", "cross_arms_infront_swep", "cross_arms_swep", "rw_sw_wristblaster_light_yellow", "rw_sw_wristrocket", "rw_sw_tusken_cycler"},
    command = "Max",
    max = 1,
    salary = 250,
    admin = 0,
...
TEAM_MANDODALA = DarkRP.createJob("Mando Dala", {
    ...
    weapons = {"stunstick", "rw_sw_dual_westar35", "keypad_cracker", "rw_sw_westar35", "weapon_fists", "re_hands", "rw_sw_westarm5", "rw_sw_iqa11", "rw_sw_wristblaster_light_blue", "jet_mk1", "weapon_cuff_elastic", "cross_arms_infront_swep", "cross_arms_swep", "weapon_bactainjector", "weapon_bactanade", "tfa_defi_swrp", "rw_sw_nade_thermal"},
    command = "mandodala",
    max = 1,
    salary = 250,
    admin = 0,
...
weapons = {"weapon_fists", "re_hands", "rw_sw_dual_westar35", "rw_sw_nt242c", "rw_sw_scattershotgun", "jet_mk1", "seal6-c4", "tfa_defi_swrp", "weapon_extinguisher_infinite", "weapon_bactainjector", "weapon_armorkit", "weapon_cuff_elastic", "extinguisher_infinite", "cross_arms_infront_swep", "cross_arms_swep", "rw_sw_wristblaster_light_yellow", "rw_sw_wristflame", "rw_sw_wristrocket", "rw_sw_tusken_cycler"},
command = "Quitt",
max = 1,
salary = 250,
admin = 0,
