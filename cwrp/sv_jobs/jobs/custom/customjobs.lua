...
TEAM_PLANK = DarkRP.createJob("RC-PLANK", {
    ...
    weapons = {"at_sw_dc15sa", "at_sw_dc17m", "weapon_cuff_elastic", "rw_sw_nade_thermal", "tfa_defi_swrp", "weapon_thehiddenblade", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "hacktool", "t3m4_empgrenade", "comlink_swep"},
    command = "plank",
    max = 1,
    salary = 250,
    admin = 0,
...
TEAM_WITT = DarkRP.createJob("RC-WITT", {
    ...
    description = [[RC_WITT]],
    weapons = {"at_sw_dc15sa", "weapon_bactanade", "realistic_hook", "rw_sw_nade_bacta", "rw_sw_dc17m_sniper", "at_sw_dc17m", "weapon_cuff_elastic", "rw_sw_nade_thermal", "tfa_defi_swrp", "weapon_bactainjector", "weapon_armorkit", "weapon_thehiddenblade", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "comlink_swep", "t3m4_empgrenade"},
    command = "witt",
    max = 1,
    salary = 250,
    admin = 0,
