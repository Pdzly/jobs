...
TEAM_327THCPTDEVISS = DarkRP.createJob("327th CMD Deviss", {
    ...
    weapons = {"rw_sw_rps6", "rw_sw_valken38x", "re_hands", "weapon_fists", "rw_sw_dc15a_o", "rw_sw_dc15s", "rw_sw_dual_dc17", "jet_exec", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic"},
