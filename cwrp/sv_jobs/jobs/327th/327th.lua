...
TEAM_327THPVT = DarkRP.createJob("327th PVT", {
    ...
    weapons = {"re_hands", "weapon_fists", "at_sw_dc15a_all", "at_sw_dc15s_all", "rw_sw_dc17", "jet_exec", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep"},
    command = "327thpvt",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_327THSGT = DarkRP.createJob("327th SGT", {
    ...
    weapons = {"rw_sw_rps6", "re_hands", "weapon_fists", "at_sw_dc15a_all", "at_sw_dc15s_all", "rw_sw_dc17", "jet_exec", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep"},
    command = "327thsgt",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_327TH2ndLT = DarkRP.createJob("327th 2ndLT", {
    ...
    weapons = {"rw_sw_rps6", "re_hands", "weapon_fists", "at_sw_dc15a_all", "at_sw_dc15s_all", "rw_sw_dc17", "jet_exec", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic"},
    command = "327th2ndlt",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_327THCPT = DarkRP.createJob("327th CPT", {
    ...
    weapons = {"rw_sw_rps6", "re_hands", "weapon_fists", "at_sw_dc15a_all", "at_sw_dc15s_all", "rw_sw_dual_dc17", "jet_exec", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic"},
    command = "327thcpt",
    max = 2,
    salary = 100,
    admin = 0,
...
TEAM_327THCPTDEVISS = DarkRP.createJob("327th CMD Deviss", {
    ...
    weapons = {"rw_sw_rps6", "rw_sw_valken38x", "re_hands", "weapon_fists", "at_sw_dc15a_all", "at_sw_dc15s_all", "rw_sw_dual_dc17", "jet_exec", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic"},
...
TEAM_327THBLY = DarkRP.createJob("Commander Bly", {
    ...
    weapons = {"rw_sw_rps6", "re_hands", "weapon_fists", "at_sw_dc15a_all", "at_sw_dc15s_all", "rw_sw_dual_dc17ext", "jet_exec", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic"},
    command = "cmdbly",
    max = 1,
    salary = 100,
    admin = 0,
