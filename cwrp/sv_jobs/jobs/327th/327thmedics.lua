TEAM_327thM = DarkRP.createJob("327th Medic ", {
    ...
    weapons = {"med_kit", "zbl_gun", "weapon_fists", "sw_datapad", "at_sw_dc15s_all", "rw_sw_dc17ext", "at_sw_dc15a_all", "tfa_defi_swrp", "jet_exec", "rw_sw_nade_bacta", "weapon_bactainjector", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "keys", "bkeycard", "re_hands", "rw_sw_stun_dc15s"},
    command = "327th_Medic",
    max = 1,
    salary = 250,
    admin = 0,
...
TEAM_327thO = DarkRP.createJob("327th Medic Offizier", {
    ...
    description = [[Medic der 327th]],
    weapons = {"med_kit", "zbl_gun", "weapon_fists", "sw_datapad", "at_sw_dc15s_all", "at_sw_dc15a_all", "tfa_defi_swrp", "jet_exec", "rw_sw_nade_bacta", "weapon_bactainjector", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "keys", "bkeycard", "re_hands", "rw_sw_dual_dc17ext", "weapon_cuff_elastic", "rw_sw_stun_dc15s"},
...
TEAM_327THMEDICPVT = DarkRP.createJob("327th-Medic PVT", {
    ...
    weapons = {"med_kit", "zbl_gun", "weapon_fists", "sw_datapad", "at_sw_dc15s_all", "at_sw_dc15a_all", "tfa_defi_swrp", "jet_exec", "rw_sw_nade_bacta", "weapon_bactainjector", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "keys", "bkeycard", "re_hands", "rw_sw_stun_dc15s"},
    command = "327medicpvt",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_327THMEDICCPT = DarkRP.createJob("327th-Medic CPT", {
    ...
    weapons = {"rw_sw_dual_dc17ext", "med_kit", "zbl_gun", "weapon_fists", "sw_datapad", "at_sw_dc15s_all", "at_sw_dc15a_all", "tfa_defi_swrp", "jet_exec", "rw_sw_nade_bacta", "weapon_bactainjector", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "keys", "bkeycard", "re_hands", "rw_sw_stun_dc15s"},
    command = "327mediccpt",
    max = 1,
    salary = 100,
    admin = 0,
