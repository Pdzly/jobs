...
TEAM_327THMEDICCPT = DarkRP.createJob("327th-Medic CPT", {
    ...
    weapons = {"rw_sw_dual_dc17ext", "med_kit", "zbl_gun", "weapon_fists", "sw_datapad", "at_sw_dc15s_all", "rw_sw_dc17ext", "at_sw_dc15a_all", "tfa_defi_swrp",  "rw_sw_nade_bacta", "weapon_bactainjector", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "keys", "bkeycard", "re_hands"},
    command = "327mediccpt",
    max = 1,
    salary = 100,
    admin = 0,
