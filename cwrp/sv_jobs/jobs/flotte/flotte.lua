...
TEAM_FK = DarkRP.createJob("Flotten Kadett", {
   ...
   model = {"models/player/kurier/fleet/grey.mdl", "models/defcon/banks/coldwweather/custom/repcom_cold/repcom_cold.mdl"},
...
TEAM_FVA = DarkRP.createJob("Flotten Rear Admiral", {
   color = Color(142, 142, 142, 255),
   model = {"models/player/kurier/fleet/admiral.mdl", "models/defcon/banks/coldwweather/custom/repcom_cold/repcom_cold.mdl"},
