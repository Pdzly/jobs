...
TEAM_FK = DarkRP.createJob("Flotten Kadett", {
   ...
   weapons = {"re_hands", "salute_swep", "cross_arms_infront_swep", "cross_arms_swep", "rw_sw_bino_white", "rw_sw_dc17ext", "weapon_cuff_elastic", "mkpad"},
   command = "FK",
   max = 3,
   salary = 200,
   admin = 0,
...
TEAM_FP = DarkRP.createJob("Flotten Petty Officer", {
   ...
   weapons = {"stunstick","re_hands", "salute_swep", "cross_arms_infront_swep", "cross_arms_swep", "rw_sw_bino_white", "rw_sw_dc17ext", "weapon_cuff_elastic", "mkpad"},
   command = "FPO",
   max = 3,
   salary = 200,
   admin = 0,
