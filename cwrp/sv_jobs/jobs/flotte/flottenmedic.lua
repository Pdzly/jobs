...
TEAM_FP = DarkRP.createJob("Flotten Petty Officer Medic", {
   ...
   weapons = {"stunstick","re_hands", "salute_swep","zbl_spray", "zbl_gun", "weapon_bactainjector" ,"weapon_medkit", "sw_datapad", "tfa_defi_swrp" ,"rw_sw_nade_bacta", "cross_arms_infront_swep", "cross_arms_swep", "rw_sw_bino_white", "rw_sw_dc17ext", "weapon_cuff_elastic"},
   command = "FPOM",
   max = 3,
   salary = 200,
   admin = 0,
