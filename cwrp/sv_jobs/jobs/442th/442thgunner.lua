TEAM_442thGunner = DarkRP.createJob("442th Gunner", {
    ...
    weapons = {"rw_sw_dc15s", "rw_sw_dc17ext", "alydus_fortificationbuildertablet", "cross_arms_swep", "cross_arms_infront_swep", "salute_swep", "weapon_fists", "re_hands",  "rw_sw_dp24", "rw_sw_nade_thermal"},
...
TEAM_442thGunnerOffizier = DarkRP.createJob("442th Gunner Offizier", {
    ...
    weapons = {"rw_sw_dc15s", "alydus_fortificationbuildertablet", "cross_arms_swep", "cross_arms_infront_swep", "salute_swep", "weapon_fists", "re_hands",  "rw_sw_dp24", "rw_sw_dual_dc17ext", "weapon_cuff_elastic", "rw_sw_nade_thermal"},
