...
TEAM_41STPFC = DarkRP.createJob("41st PFC", {
    ...
    weapons = {"realistic_hook", "re_hands", "at_sw_dc15a_all", "at_sw_dc15a_all", "weapon_fists", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_bino_white", "rw_sw_dc17ext"},
    command = "41stpfc",
    max = 10,
    salary = 100,
    admin = 0,
...
TEAM_41STLCL = DarkRP.createJob("41st LCL", {
    ...
    weapons = {"realistic_hook", "re_hands", "at_sw_dc15a_all", "at_sw_dc15a_all", "weapon_fists", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_bino_white", "rw_sw_dc17ext", "rw_sw_nade_thermal"},
    command = "41stlcl",
    max = 8,
    salary = 100,
    admin = 0,
...
TEAM_41STCPL = DarkRP.createJob("41st CPL", {
    ...
    weapons = {"realistic_hook", "re_hands", "at_sw_dc15a_all", "at_sw_dc15a_all", "weapon_fists", "cross_arms_infront_swep", "rw_sw_nade_thermal", "cross_arms_swep", "salute_swep", "rw_sw_dc15x", "rw_sw_bino_white", "rw_sw_dc17ext"},
    command = "41stcpl",
    max = 8,
    salary = 100,
    admin = 0,
...
TEAM_41STSGT = DarkRP.createJob("41st SGT", {
    ...
    weapons = {"realistic_hook", "re_hands", "at_sw_dc15a_all", "at_sw_dc15a_all", "weapon_fists", "cross_arms_infront_swep", "cross_arms_swep", "rw_sw_nade_thermal", "salute_swep", "rw_sw_dc15x", "rw_sw_bino_white", "rw_sw_dc17ext"},
    command = "41stsgt",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_41STSGTMJ = DarkRP.createJob("41st SGTMJ", {
    ...
    weapons = {"realistic_hook", "re_hands", "at_sw_dc15a_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_nade_thermal", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_dc15x", "rw_sw_bino_white", "rw_sw_dc17ext"},
    command = "41stsgtmj",
    max = 2,
    salary = 100,
    admin = 0,
...
TEAM_41ST2ndLT = DarkRP.createJob("41st 2ndLT", {
    ...
    weapons = {"realistic_hook", "re_hands", "at_sw_dc15a_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_nade_thermal", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_dc15x", "rw_sw_bino_white", "rw_sw_dc17ext", "weapon_cuff_elastic"},
    command = "41st2ndlt",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_41STCPT = DarkRP.createJob("41st CPT", {
    ...
    weapons = {"realistic_hook", "re_hands", "at_sw_dc15a_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_nade_thermal", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_dc15x", "rw_sw_bino_white", "rw_sw_dc17ext", "weapon_cuff_elastic", "rw_sw_dual_dc17ext"},
    command = "41stcpt",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_41STMJR = DarkRP.createJob("41st MJR", {
    ...
    weapons = {"realistic_hook", "re_hands", "at_sw_dc15a_all", "at_sw_dc15a_all", "weapon_fists", "rw_sw_nade_thermal", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_dc15x", "rw_sw_bino_white", "weapon_cuff_elastic", "rw_sw_dual_dc17ext", "rw_sw_dc17ext"},
    command = "41stmjr",
    max = 1,
    salary = 100,
    admin = 0,
