...
TEAM_STPVT = DarkRP.createJob("STPVT", {
    ...
    description = [[STPVT]],
    weapons = {"rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "stunstick", "re_hands", "at_sw_dc15a_all", "weapon_fists", "swep_mexicanshockstaff", "weapon_cuff_elastic", "arrest_stick", "unarrest_stick", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "mkpad"},
    command = "stpvt",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_STPFC = DarkRP.createJob("STPFC", {
    ...
    model = {"models/fisher/shock/soldier/soldier.mdl", "models/player/ricky/dg/shock/ricky_shockriot.mdl", "models/defcon/banks/coldwweather/cg_cold/cg_trooper/cg_trooper.mdl"},
    description = [[STPFC]],
    weapons = {"rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "stunstick", "re_hands", "at_sw_dc15a_all", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "mkpad"},
    command = "stpfc",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_STLCL = DarkRP.createJob("STLCL", {
    ...
    model = {"models/fisher/shock/soldier/soldier.mdl", "models/player/ricky/dg/shock/ricky_shockriot.mdl", "models/defcon/banks/coldwweather/cg_cold/cg_trooper/cg_trooper.mdl"},
    description = [[STLCL]],
    weapons = {"rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "re_hands", "at_sw_dc15a_all", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "mkpad"},
    command = "stlcl",
    max = 8,
    salary = 100,
    admin = 0,
...
TEAM_STHOUND = DarkRP.createJob("ST SGT HOUND", {
    ...
    weapons = {"rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "stunstick", "weapon_cuff_rope", "re_hands", "at_sw_dc15a_all", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "mkpad"},
    command = "stsgthound",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_STSGTMJ = DarkRP.createJob("STSGTMJ", {
    ...
    model = {"models/fisher/shock/soldier/soldier.mdl", "models/player/ricky/dg/shock/ricky_shockriot.mdl", "models/defcon/banks/coldwweather/cg_cold/cg_trooper/cg_trooper.mdl"},
    description = [[STSGTMJ]],
    weapons = {"rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "stunstick", "re_hands", "at_sw_dc15a_all", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "mkpad", "mkpad"},
    command = "stsgtmj",
    max = 2,
    salary = 100,
    admin = 0,
...
TEAM_STCPT = DarkRP.createJob("STCPT", {
    ...
    model = {"models/fisher/shock/soldier/soldier.mdl", "models/player/ricky/dg/shock/ricky_shockriot.mdl", "models/defcon/banks/coldwweather/cg_cold/cg_trooper/cg_trooper.mdl"},
    description = [[STCPT]],
    weapons = {"rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "stunstick", "re_hands", "at_sw_dc15a_all", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dual_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "mkpad"},
    command = "stcpt",
    max = 2,
    salary = 100,
    admin = 0,
...
TEAM_STFOX = DarkRP.createJob("Commander Fox", {
    ...
    weapons = {"rw_sw_rps6", "rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "stunstick", "re_hands", "at_sw_dc15a_all", "seal6-c4", "weapon_breachingcharge", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dual_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic", "mkpad", "mkpad"},
    command = "cmdfox",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_STTHORN = DarkRP.createJob("Commander Thorn", {
    ...
    weapons = {"rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "rw_sw_z6", "stunstick", "re_hands", "at_sw_dc15a_all", "seal6-c4", "weapon_breachingcharge", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dual_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic", "mkpad"},
    command = "cmdthorn",
    max = 1,
    salary = 100,
    admin = 0,
