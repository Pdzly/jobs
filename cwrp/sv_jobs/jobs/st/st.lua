...
TEAM_Stone = DarkRP.createJob("ST CPT Stone", {
    ...
    weapons = {"rw_sw_dual_dc17ext", "stunstick", "weapon_breachingcharge", "rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "cross_arms_infront_swep", "cross_arms_swep", "rw_sw_shield_cg_dc15s", "salute_swep", "surrender_animation_swep", "keys", "weapon_cuff_elastic", "swep_mexicanshockstaff", "re_hands", "sw_datapad", "rw_sw_nade_thermal", "at_sw_dc15a_all", "bkeycard", "mkpad"},
    command = "atcptstone",
    max = 1,
    salary = 100,
    admin = 0,
