...
TEAM_STMEDICPVT = DarkRP.createJob("ST Medic PVT", {
    ...
    weapons = {"stunstick", "rw_sw_nade_bacta", "weapon_bactainjector", "rw_sw_shield_rep_dc17", "tfa_defi_swrp", "re_hands", "at_sw_dc15a_all", "weapon_fists", "swep_mexicanshockstaff", "weapon_cuff_elastic", "arrest_stick", "unarrest_stick", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep"},
    command = "stmedicpvt",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_STMEDICPFC = DarkRP.createJob("ST Medic PFC", {
    ...
    model = {"models/fisher/shock/medic/medic.mdl", "models/player/ricky/dg/shock/ricky_shockriot.mdl", "models/defcon/banks/coldwweather/cg_cold/cg_trooper/cg_trooper.mdl"},
    description = [[STPFC]],
    weapons = {"stunstick", "rw_sw_nade_bacta", "weapon_bactainjector", "rw_sw_shield_rep_dc17", "tfa_defi_swrp", "re_hands", "at_sw_dc15a_all", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep"},
    command = "stmedicpfc",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_STMEDICCPL = DarkRP.createJob("ST Medic CPL", {
    ...
    description = [[STCPL]],
    weapons = {"rw_sw_nade_bacta", "weapon_bactainjector", "tfa_defi_swrp", "rw_sw_shield_rep_dc17", "re_hands", "at_sw_dc15a_all", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep"},
    command = "stmediccpl",
    max = 8,
    salary = 100,
    admin = 0,
