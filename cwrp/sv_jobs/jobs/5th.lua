...
TEAM_ 5thCPT= DarkRP.createJob("5th CPT", {
    ...
    model = {"models/player/ven/bf2_reg/5thfleet/bf25thfleet.mdl"},
    description = [[5th CPT]],
    weapons = {"cross_arms_swep", "cross_arms_infront_swep", "weapon_cuff_elastic", "rw_sw_dual_dc17", "at_sw_dc15s_all", "at_sw_dc15a_all", "rw_sw_bino_dark", "rw_sw_dc17", "sw_datapad", "t3m4_empgrenade", "surrender_animation_swep", "salute_swep", "weapon_fists", "re_hands"},
    command = "5thCPT",
    max = 0,
    salary = 100,
    admin = 0,
