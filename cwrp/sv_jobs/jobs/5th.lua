...
TEAM_5thPVT= DarkRP.createJob("5th PVT", {
    ...
    description = [[5th PVT]],
    weapons = {"cross_arms_swep", "cross_arms_infront_swep", "weapon_cuff_elastic", "at_sw_dc15s_all", "at_sw_dc15a_all", "rw_sw_bino_dark", "rw_sw_dc17ext", "sw_datapad", "t3m4_empgrenade", "surrender_animation_swep", "salute_swep", "weapon_fists", "re_hands"},
    command = "5thPVT",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_5thCPT= DarkRP.createJob("5th CPT", {
    ...
    model = {"models/player/ven/bf2_reg/5thfleet/bf25thfleet.mdl"},
    description = [[5th CPT]],
    weapons = {"cross_arms_swep", "cross_arms_infront_swep", "weapon_cuff_elastic", "rw_sw_dual_dc17ext", "at_sw_dc15s_all", "at_sw_dc15a_all", "rw_sw_bino_dark", "rw_sw_dc17ext", "sw_datapad", "t3m4_empgrenade", "surrender_animation_swep", "salute_swep", "weapon_fists", "re_hands"},
    command = "5thCPT",
    max = 0,
    salary = 100,
    admin = 0,
